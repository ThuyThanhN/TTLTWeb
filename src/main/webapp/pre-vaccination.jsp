...
<head>
    ...
    <title>Những điều cần biết trước khi tiêm chủng</title>
...
<div id="wrapper">
    ...
    <div class="main">
        <div class="container">
            <h4 class="title">Những điều cần biết trước khi tiêm chủng</h4>
            <h5>Khám sàng lọc trước tiêm chủng</h5>
            <h6>1. Tại sao cần khám sàng lọc trước khi tiêm chủng</h6>
            ...
            <p><b>Với trẻ nhỏ</b>, bố mẹ cần thông báo cho bác sĩ các vấn đề về sức khỏe và lịch sử tiêm chủng như:</p>
            <ul>
            ...
            <p><b>Với người lớn đi tiêm chủng</b> cũng cần thông báo cho bác sĩ các vấn đề sức khỏe của mình bao gồm các bệnh đã mắc, những loại thuốc – liệu pháp điều trị đang dùng, loại vắc xin đã tiêm gần đây (trong vòng 4 tuần) và phản ứng của cơ thể ở những lần tiêm chủng trước hoặc các phản ứng, dị ứng đã gặp.</p>
            <p><b>Với phụ nữ</b>, ngoài các thông tin cơ bản như trên, cần thông báo cho bác sĩ biết mình đang có thai hay không, hoặc thời gian dự định có thai.</p>
            <div class="alert-info">
                <h6>Bác sĩ sẽ khám như thế nào</h6>
                <div>Việc khám sàng lọc trước tiêm chủng được thực hiện theo đúng quy định nghiêm ngặt của Bộ Y Tế (Quyết định số 2470/QĐ-BYT ban hành ngày 14/6/2019), tập trung vào việc đánh giá tình trạng sức khỏe chung của cơ thể bao gồm:</div>
                <ul>
                    <li>Đo thân nhiệt</li>
            ...
            <h5>Hướng dẫn trước khi tiêm chủng</h5>
            <p>
                <b>Với trẻ nhỏ:</b>
            <ul>
            ...
            <b>Với người lớn:</b>
            <p>Người lớn đi tiêm chủng cũng cần thông báo cho bác sĩ các vấn đề sức khỏe của mình bao gồm các bệnh đã mắc, các loại thuốc – liệu pháp điều trị đang dùng, loại vắc xin đã tiêm gần đây (trong vòng 4 tuần) và phản ứng của cơ thể ở những lần tiêm chủng trước.
            </p>
        </div>
    </div>
    <!-- Footer -->
