...
<c:set var="vcontent" value="${requestScope.vcontent}"/>
<c:set var="vdetail" value="${requestScope.vdetail}"/>
            ...
            <div class="row">
                <div class="col-12 col-md-7">
                    <div class="vaccine-info-form">
                        <div class="section-title border-bottom p-3">Cập nhật vắc xin</div>
                        <div class="p-3">
                            <div class="row">
                                <input type="hidden" name="idVaccine" value="${v.id}">
                                <div class="col-6">
                                    <div class="mb-3">
                                ...
                                <div class="col-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" id="quantity-vaccine" name="quantity"
                                ...
                                <div class="col-4">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select form-control" id="supplier-select"
                                                name="supplierName" value="${s.name}">
                                            <c:forEach var="s" items="${suppliers}">
                                                <option value="${s.id}" ${s.id == supplier.id ? 'selected' : ''}>${s.name}</option>
                                            </c:forEach>
                                        </select>
                                ...
                                <div class="col-6">
                                    <div class="mb-3">
                                        ...
                                        <textarea id="editor-des" class="ckeditor"
                                ...
                                <div class="col-6">
                                    <div class="mb-3">
                                        ...
                                        <textarea id="editor-pre" class="ckeditor"
                                                  name="prevention">${v.prevention}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="p-3">
                                    ...
                                    <div class="accordion" id="accordionExample">
                                                ...
                                                <div class="col-12">
                                                    <div class="mb-3">
                                                        <textarea class="ckeditor"
                                                                  name="editor-ng">${vcontent.origin}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="accordion-item">
                                            ...
                                            <div id="collapseThree" class="accordion-collapse collapse"
                                                ...
                                                <div class="form-floating p-3">
                                                    <textarea class="ckeditor"
                                                              name="editor-ccd">${vcontent.contraindications}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="accordion-item">
                                            ...
                                            <div id="collapseFour" class="accordion-collapse collapse"
                                                ...
                                                <div class="form-floating p-3">
                                                    <textarea class="ckeditor"
                                                              name="editor-tt">${vcontent.precaution}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="accordion-item">
                                            ...
                                            <div id="collapseFive" class="accordion-collapse collapse"
                                                ...
                                                <div class="form-floating p-3">
                                                    <textarea class="ckeditor"
                                                              name="editor-ttt">${vcontent.drugInteractions}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="accordion-item">
                                            ...
                                            <div id="collapseSix" class="accordion-collapse collapse"
                                                ...
                                                <div class="form-floating p-3">
                                                    <textarea class="ckeditor"
                                                              name="editor-tdp">${vcontent.sideEffects}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="my-3 content d-none" id="schedule-content">
                                <div class="form-floating">
                                    ...
                                    <textarea class="ckeditor" name="editor-pdt">${vdetail.immunization}</textarea>
                                </div>
                            </div>
                            <div class="my-3 content d-none" id="reaction-content">
                                <div class="form-floating">
                                    <div>Phản ứng</div>
                                    <textarea class="ckeditor" name="editor-pu">${vdetail.adverseReactions}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="mb-3">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select form-control" id="form-select-vaccine1"
                                                    name="disase-name">
                                                <option value="0">--Chọn nhóm bệnh--</option>
                                                <c:forEach var="d" items="${disases}">
                                                    <option value="${d.id}" ${d.id == disase.id ? 'selected' : ''}>${d.name}</option>
                                                </c:forEach>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select form-control" id="form-select-vaccine2"
                                            ...
                                            <c:forEach var="a" items="${ages}">
                                                <option value="${a.id}" ${a.id == age.id ? 'selected' : ''}>${a.name}</option>
                                            </c:forEach>
                                        </select>
                                    </div>
                                </div>
