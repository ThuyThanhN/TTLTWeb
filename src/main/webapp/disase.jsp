    ...
    <div class="main">
        <div class="vaccine-info-container">
            ...
            <div class="button-group">
                ...
                <%--                <button class="btn" onclick="location.href='/vaccine-information?agegroupId=<c:out value="${agegroups.id}" />'">VẮC XIN THEO NHÓM ĐỘ TUỔI</button>--%>
                ...
                <button class="btn" >VẮC XIN THEO NHÓM BỆNH</button>
            </div>
        ...
        <div class="main-content">
            <div class="container">
                <div class="row">
                    <c:forEach var ="vd" items="${vaccinesDisase}">
                        <div class="col-12 col-md-4 mb-3">
                            <div class="vx_item">
                                <a href="">
                                    <img src="${vd.imageUrl}" alt="">
                                    <div class="vaccine_name" title="${vd.name}">${vd.name}</div>
                                </a>
                                <div class="vaccine-content">${vd.description}</div>
                            </div>
                        </div>
                    </c:forEach>
                </div>
