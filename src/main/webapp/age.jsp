    ...
    <div class="main">
        <div class="vaccine-info-container">
            ...
            <div class="button-group">
                ...
                <button class="btn">VẮC XIN THEO NHÓM ĐỘ TUỔI</button>
        ...
        <div class="main-content">
            <div class="container">
                <div class="row">
                    <c:forEach var ="va" items="${vaccinesAge}">
                        <div class="col-12 col-md-4 mb-3">
                            <div class="vx_item">
                                <a href="">
                                    <img src="${va.imageUrl}" alt="">
                                    <div class="vaccine_name" title="${va.name}">${va.name}</div>
                                </a>
                                <div class="vaccine-content">${va.description}</div>
                            </div>
                        </div>
                    </c:forEach>
                </div>
